...
def main():
    ...
    report_entries = [
        {
            ...
            "liquidity_risk": "Low",
            "santiment_score": 2,
            "santiment_surge_score": 3,
            "santiment_surge_explanation": "Net exchange outflow, whale accumulation, dev activity surge",
            "rsi_score": 0.0,
        ...
        },
        {
            ...
            "liquidity_risk": "Low",
            "santiment_score": 1,
            "santiment_surge_score": 2,
            "santiment_surge_explanation": "Dev activity increase, positive weighted sentiment",
            "rsi_score": 1.0,
        ...
        },
        {
            ...
            "santiment_score": 2,
            "santiment_surge_score": 3,
            "santiment_surge_explanation": "Exchange outflow spike, whale txs, volume surge, positive sentiment",
            "rsi_score": 1.0,
    ...
    # Send the email (no plot image in test mode)
    send_email_with_report(
        html_report,
        attachment_path,
        plot_image_path="nonexistent.png",  # Skip plot attachment
